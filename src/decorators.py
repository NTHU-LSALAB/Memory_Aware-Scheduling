        ...
        class Wrapped(cls):
            ...
            def schedule(self, tasks: list[Task], input, options={}, format='default') -> tuple[list[list[Task]], int]:
                ...
                if options.get('plot', True):
                    ...
                    self.memory.plot(
                        makespan, filename=f'{self.algo_name}-base{suffix}')
                    self.plot(schedule, makespan, f'{self.algo_name}-base{suffix}')
        ...
        class Wrapped(cls):
            ...
            def schedule(self, tasks: list[Task], input, options={}, format='default') -> tuple[list[list[Task]], int]:
                ...
                if options.get('plot', True):
                    suffix = options.get('suffix', '')
                    self.memory.plot(
                        makespan, filename=f'{self.algo_name}-delay{suffix}')
                    if options.get('snapshot'):
                        self.memory.plot_snapshot(
                            makespan, filename=f'{self.algo_name}-delay{suffix}')
                    self.plot(schedule, makespan, f'{self.algo_name}-delay{suffix}')
                return schedule, makespan, self.memory.max()
        return Wrapped
    return wrapper
        ...
        class Wrapped(cls):
            ...
            def schedule(self, tasks: list[Task], input, options: dict = {}, format='default') -> tuple[list[list[Task]], int]:
                ...
                if options.get('plot', True):
                    suffix = options.get('suffix', '')
                    self.memory.plot(
                        self.makespan, filename=f'{self.algo_name}-reserve{suffix}')
                    if options.get('snapshot'):
                        self.memory.plot_snapshot(
                            self.makespan, filename=f'{self.algo_name}-reserve{suffix}')
                    self.plot(self.schedule, self.makespan,
                            f'{self.algo_name}-reserve{suffix}')
        ...
        class Wrapped(cls):
            ...
            def schedule(self, tasks: list[Task], input, options={}, format='default') -> tuple[list[list[Task]], int]:
                ...
                if options.get('plot', True):
                    suffix = options.get('suffix', '')
                    self.memory.plot(
                        makespan, filename=f'{self.algo_name}-sbac{suffix}')
                    self.plot(schedule, makespan, f'{self.algo_name}-sbac{suffix}')
                return schedule, makespan, self.memory.max()
